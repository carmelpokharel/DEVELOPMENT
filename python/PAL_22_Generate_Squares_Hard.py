...
class PAL_22_Generate_Squares_Hard(object):
	...
	def PAL_22_Print_Body(self, square_num, outFile):
		...
		outFile.write('\n        <a href="square_'+unicode(square_num)+'.html"><div class="box-square2"><div class="box-square-number2" onclick=""><img style="width:80%;height:100%;max-width:47px" src="../../../images/ladder.png"></div></div></a>')
	...
	def PAL_22_Generate_Squares_Hard(self):
		...
		for page_num in range(1,101):
			...
			current_content_file = self.CONTENT_PATHS + unicode(page_num) + '_hard.txt'
			if os.path.exists(current_content_file):
				...
				current_square_html_file = self.HTML_PATHS + unicode(page_num) + '_hard.html'
				...
				# Print the title
				self.Utilities.PAL_90_Print_Title('Square ' + unicode(page_num) + ' (Hard)', outFile)
