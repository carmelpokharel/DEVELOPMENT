...
class PAL_21_Generate_Squares_Easy(object):
	...
	def PAL_21_Print_Header_Template(self, outFile):
	...
	def PAL_21_Print_Closing_Tags_Template(self, outFile):
		for closing_tag in self.Closing_Tags_Data:
			outFile.write(closing_tag)


	def PAL_21_Load_Square_Content(self, current_content_file, square_num):
	...
	def PAL_21_Print_Mini_Row(self, outFile):
	...
	def PAL_21_Print_Body(self, square_num, outFile):
		...
		outFile.write('\n          <h4 class="h4gold">Task '+alphanum+' (Easy)</h4>')
	...
	def PAL_21_Generate_Squares_Easy(self):
		...
		for page_num in range(1,101):
			...
			if os.path.exists(current_content_file):
				...
				# Print the header
				self.PAL_21_Print_Header_Template(outFile)
...
if __name__ == '__main__':
	...
	# Initialize object
	#------------------
	Generate_Squares_Easy = PAL_21_Generate_Squares_Easy()
	Generate_Squares_Easy.PAL_21_Generate_Squares_Easy()
