...
class PAL_20_Generate_Puzzles(object):
	...
	def PAL_20_Print_Body(self, puzzle_num, outFile):
		...
		outFile.write('\n                <a href="#" style="border-bottom:0px" class="bootstrap-popover" title="'+random.choice(titles).lower()+'" data-content="'+hintcontent+'">')
		outFile.write('\n                HINT')
		outFile.write('\n                </a>')
		outFile.write('\n              </div><!-- editortoolbaritems -->')
		if int(puzzle_num) > 42 and int(puzzle_num) not in [65,66,67,70,75,76]:
		...
		# Print test cases
		if len(self.Puzzle_Info['$RIGHTPANEL_TESTCASES$\n']) > 1:
		...
		# # Mini-navigation
		# outFile.write('\n         <div class="rightpane">')
		# outFile.write('\n          <div class="minigameboard">')
		# self.PAL_20_Print_Mini_Row (outFile)
		# outFile.write('\n          </div><!-- minigameboard -->')
		# outFile.write('\n          </div><!-- rightpane -->')
