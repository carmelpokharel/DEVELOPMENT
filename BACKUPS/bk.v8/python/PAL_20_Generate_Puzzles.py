...
class PAL_20_Generate_Puzzles(object):
	...
	def PAL_20_Print_Body(self, puzzle_num, outFile):
		...
		outFile.write('\n        <a href="puzzle_'+unicode(puzzle_num)+'.html"><div class="box-puzz2"><div class="box-puzzle-number2">'+unicode(puzzle_num)+'</div></div></a>')
		if unicode(puzzle_num) != '1':
			outFile.write('\n        <a href="'+previous_puzzle+'"><div class="box-puzz2"><div class="box-puzzle-arrows2">&lang;</div></div></a>')
		if unicode(puzzle_num) != '100':
			outFile.write('\n        <a href="'+next_puzzle+'"><div class="box-puzz2"><div class="box-puzzle-arrows2">&rang;</div></div></a>')
			outFile.write('\n      </div>')
		...
		# Print navigation
		outFile.write('\n      <div class="puzzlenav">')
		outFile.write('\n        <a href="puzzle_'+unicode(puzzle_num)+'.html"><div class="box-puzz"><div class="box-puzzle-number">'+unicode(puzzle_num)+'</div></div></a>')
		if unicode(puzzle_num) != '1':
			outFile.write('\n        <a href="'+previous_puzzle+'"><div class="box-puzz"><div class="box-puzzle-arrows">&lang;</div></div></a>')
		if unicode(puzzle_num) != '100':
			outFile.write('\n        <a href="'+next_puzzle+'"><div class="box-puzz"><div class="box-puzzle-arrows">&rang;</div></div></a>')
		outFile.write('\n      </div>')
		...
		for mini_box_number in range(1, 101):
			...
			if not mini_box_number == int(puzzle_num):
				...
				outFile.write('\n          <div class="box-mini-grid-curr">'+unicode(mini_box_number)+'</div>')
			outFile.write('\n          </a>')
		outFile.write('\n          </div>')
		outFile.write('\n         </div>')
		outFile.write('\n      </div>')
