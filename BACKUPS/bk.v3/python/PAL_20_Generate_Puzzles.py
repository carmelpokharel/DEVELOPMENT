...
class PAL_20_Generate_Puzzles(object):
	...
	def PAL_20_Print_Body(self, puzzle_num, outFile):
		...
		# Print navigation
		outFile.write('\n      <div align="right">')
		outFile.write('\n        <a href="puzzle_'+unicode(puzzle_num)+'.html"><div class="puzzlebox">'+unicode(puzzle_num)+'</div></a>')
		outFile.write('\n        <a href="'+previous_puzzle+'"><div class="box'+unicode(3)+'">&lang;</div></a>')
		outFile.write('\n        <a href="'+next_puzzle+'"><div class="box'+unicode(3)+'">&rang;</div></a>')
		outFile.write('\n      </div>')
		...
		for question in self.Puzzle_Info['$RIGHTPANEL_QUESTIONS$\n']:
			outFile.write('\n            <li class="small">'+question.strip('\n')+'</li>')
		outFile.write('\n          </ol>')
		# outFile.write('\n        <p class="small">&nbsp;</p>')

		# Print learning time
		# outFile.write('\n          <h4 class="greyheading">SUGGESTED TIME</h4>')
		# outFile.write('\n          <p class="small">'+self.Puzzle_Info['$RIGHTPANEL_TIME$\n'][0].strip('\n')+'</p>')
