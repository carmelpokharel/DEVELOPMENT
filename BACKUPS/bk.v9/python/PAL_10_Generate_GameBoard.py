...
class PAL_10_Generate_GameBoard(object):
	...
	def PAL_10_Print_Body(self, outFile):
		...
		outFile.write('\n      <h2 class="homepagetitle">w e l c o m e</h2>')
		# outFile.write('\n      <hr class="homepagebreak">')
		for sentence in self.GameBoard_Info['$LEFTPANEL_WELCOME$\n']:
			outFile.write('\n          <p class="homeblurb">'+sentence.strip('\n')+'</p>')

		outFile.write('\n          <a href="./main/tutorials/pages/tutorial_1.html">')
		outFile.write('\n          <div class="redbox" onclick="">Take the tutorial &rang;</div>')
		outFile.write('\n          </a>')

		outFile.write('\n          <a href="overview.html">')
		outFile.write('\n          <div class="whitebox" onclick="">Learn more</div>')
		outFile.write('\n          </a>')
